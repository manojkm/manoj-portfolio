...
export default function Hero() {
  ...
  return (
    <div className='pt-16 pb-2 sm:pt-24 sm:pb-6 md:pt-32 md:pb-20 lg:pt-36 lg:pb-24 relative overflow-hidden min-h-[100svh] flex items-center'>
      <div className='relative z-10 px-4 sm:px-6 md:px-8 w-full'>
        ...
        <div className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-center leading-tight'>
          ...
          >
            <h1 className='text-[#98B4CE] drop-shadow-[0_0_25px_rgba(152,180,206,0.5)]'>Hi, I'm</h1>
          </motion.div>
          ...
          >
            <h1 className='text-[#E48A57] drop-shadow-[0_0_30px_rgba(228,138,87,0.6)]'>Manoj K.M</h1>
          </motion.div>
